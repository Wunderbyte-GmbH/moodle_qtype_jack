...
/**
 * Strings for component 'qtype_jack', language 'de'
 *
 * @package    qtype_jack
 * @subpackage jack
...
$string['jackoptions'] = 'Jack Einstellungen';
...
$string['pluginnameadding'] = 'Jack Aufgabe hinzufügen';
$string['pluginnameediting'] = 'Jack Aufgabe bearbeiten';
$string['pluginnamesummary'] = 'Eine JACK-Frage erlaubt eine Antwort als Datei und/oder als Onlinetext. Diese Antworten werden durch einen backgroundprocess bewertet.';
$string['privacy:metadata'] = 'Das JACK-Frage Frageformat Plugin speichert keine personenbezogenen Daten.';
